...
const updateInfoById = catchAsync(async(req, res) => {
    res.success(await commentService.updateById(req.params.id, req.body), 'Update successfully')
})

const deleteInfoById = catchAsync(async(req, res) => {
    res.success(await commentService.deleteById(req.params.id), 'Deleted successfully')
})
